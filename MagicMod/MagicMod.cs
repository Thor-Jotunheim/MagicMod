...
namespace MagicMod
{
    ...
    public class MagicMod : BaseUnityPlugin
    {
        ...
        private ItemStandInteractions itemStandInteractions;

        void Awake()
        {
            // Initialize the ItemStandInteractions class
            itemStandInteractions = new ItemStandInteractions();
            itemStandInteractions.InitializeItemStandInteractions(harmony); // Initialize the item stand interactions
